...
**Note (v0.29.4):** No longer accepts a `tags` prop. Server-side tag collection is handled internally without the previous `solid-js/web` module augmentation pattern.
