...
Real-world examples demonstrating each principle. Each example shows what LLMs commonly do wrong and how to apply the correct approach.
...
### Wrong — Strategy Pattern for Simple Math
...
### Wrong — Improves Everything in Sight
...
## Goal-Driven Execution: Multi-Step with Verification

**User Request:** "Add rate limiting to the API"

### Wrong — All at Once, 300 Lines, No Verification Steps
...
## Goal-Driven Execution: Test-First Bug Fix
