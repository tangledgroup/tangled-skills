...
- **TypeScript nodenext module support fix** — Resolved TypeScript 4.7+ `nodenext` module resolution issues for proper ESM/CJS interop
- Minor documentation and CI improvements
