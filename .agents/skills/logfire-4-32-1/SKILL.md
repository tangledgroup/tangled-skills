...
- **Environment variables** (see [reference/02-configuration.md](reference/02-configuration.md))
...
See [reference/02-configuration.md](reference/02-configuration.md) for the full list.
...
See [reference/03-integrations.md](reference/03-integrations.md) for detailed integration documentation.

## Advanced Topics
## Advanced Topics

- [Quick Start](reference/01-quick-start.md)
- [Configuration](reference/02-configuration.md)
- [Integrations](reference/03-integrations.md)
- [Scrubbing](reference/04-scrubbing.md)
- [Sampling](reference/05-sampling.md)
- [Distributed Tracing](reference/06-distributed-tracing.md)
- [Sql Reference](reference/07-sql-reference.md)
- [Query Api](reference/08-query-api.md)
- [Otel Collector](reference/09-otel-collector.md)
- [Mcp Server](reference/10-mcp-server.md)
- [Testing](reference/11-testing.md)
- [Data Scrubbing](reference/12-data-scrubbing.md)
- [Sampling](reference/13-sampling.md)
- [Distributed Tracing](reference/14-distributed-tracing.md)
- [Sql Querying](reference/15-sql-querying.md)
- [Query Api](reference/16-query-api.md)
- [Opentelemetry Collector Integration](reference/17-opentelemetry-collector-integration.md)
- [Mcp Server](reference/18-mcp-server.md)
- [Testing](reference/19-testing.md)
- [Cli Reference](reference/20-cli-reference.md)
- [Data Regions](reference/21-data-regions.md)
- [Languages Supported](reference/22-languages-supported.md)
- [Web Ui Features](reference/23-web-ui-features.md)
- [Self Hosting](reference/24-self-hosting.md)
- [Key Api Reference](reference/25-key-api-reference.md)
