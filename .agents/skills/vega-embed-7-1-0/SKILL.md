...
description: >
  Embed interactive Vega and Vega-Lite visualizations into web pages.
  Load specs from URLs or JSON objects, render with SVG or Canvas, add export/source actions,
  apply themes, tooltips, patches, and custom renderers. Use when embedding
  interactive data visualizations in browser applications via CDN or bundlers.
license: MIT
...
category: library
external_references:
  - https://www.npmjs.com/package/vega-embed/v/7.1.0
  - https://github.com/vega/vega-embed/tree/v7.1.0
---
