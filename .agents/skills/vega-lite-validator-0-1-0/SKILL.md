...
description: Validates Vega-Lite 6.4.3 JSON specifications against the official JSON Schema using check-jsonschema. Catches structural errors, invalid field types, and missing required properties before rendering. Use when validating Vega-Lite specs generated by applications, pipelines, or agents, or debugging schema violations in visualization definitions.
---
