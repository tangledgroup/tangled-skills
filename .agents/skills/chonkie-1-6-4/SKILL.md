...
**Integrations**: Embedding providers (9+), LLM Genies (5+), Vector database handshakes (10+), Porters, Tokenizers, Chefs, Fetchers → See [Integrations](reference/03-integrations.md)
