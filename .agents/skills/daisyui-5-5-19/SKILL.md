...
Version 5.5.19 includes bug fixes for RTL breadcrumbs margins, focused tab z-index, button styles in prose, join item z-index, collapse transitions, drawer rule priority, and range slider color issues on ultrawide screens, among others since 5.5.0.
