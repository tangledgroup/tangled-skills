...
**Extensions System**: Tool registration, event hooks, custom UI, state management, rendering, message_end replacement → [Extensions](reference/02-extensions.md)

**Session Management**: JSONL format, tree structure, branching, compaction, fork/clone → [Sessions](reference/03-sessions.md)

**Providers & Models**: Built-in providers (Cloudflare AI Gateway, Moonshot AI), custom models.json, OAuth, API types, compat flags → [Providers](reference/04-providers.md)
