...
## Changelog (1.3.0 → 1.3.2)

### v1.3.2

- **Fix**: Regression from v1.3.0 that could cause an infinite loop when a server function returns unexpected response (e.g., S3/XML error responses) (#e534ea8)
