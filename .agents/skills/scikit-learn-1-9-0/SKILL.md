...
| Reference | Content |
|-----------|---------|
| [00-core-api](references/00-core-api.md) | BaseEstimator, mixins, Pipeline, ColumnTransformer, clone, config |
| [01-classifiers](references/01-classifiers.md) | All classification estimators and their key parameters |
| [02-regressors](references/02-regressors.md) | All regression estimators and their key parameters |
| [03-clustering](references/03-clustering.md) | Clustering algorithms: KMeans, DBSCAN, Agglomerative, etc. |
| [04-preprocessing](references/04-preprocessing.md) | Scalers, encoders, imputers, transformers |
| [05-model-selection](references/05-model-selection.md) | CV splitters, GridSearchCV, cross_validate, learning curves |
| [06-metrics](references/06-metrics.md) | Classification/regression metrics, scorers, display classes |
| [07-feature-selection](references/07-feature-selection.md) | RFE, SelectKBest, VarianceThreshold, mutual info |
| [08-dimensionality-reduction](references/08-dimensionality-reduction.md) | PCA, SVD, NMF, manifold methods |
| [09-data-io](references/09-data-io.md) | Built-in datasets, fetch_openml, synthetic data generators |
| [10-advanced-topics](references/10-advanced-topics.md) | Callbacks, metadata routing, FrozenEstimator, experimental features |
