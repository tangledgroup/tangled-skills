# numeral.js Format Types and Localization

This reference covers detailed format types, localization support, and advanced formatting options.
...
## Global Configuration and Format Strings

Also covering global configuration and format string syntax.
...
- [Format Types and Localization](references/01-format-types-and-localization.md) - Detailed format types, locale support, and advanced formatting
