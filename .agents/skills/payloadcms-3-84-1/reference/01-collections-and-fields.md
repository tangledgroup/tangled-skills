...
#### View Override System (New in 3.83)

Lexical supports a view override system for custom node rendering in the admin UI:
...

{
  ...
  editor: lexicalEditor({
    features: ({ rootFeatures }) => [
      ...rootFeatures,
      // Custom view for a specific node type
      HeadingFeature({
        views: {
          Edit: '@/components/CustomHeadingEdit',
          View: '@/components/CustomHeadingView',
        },
      }),
    ],
  }),
