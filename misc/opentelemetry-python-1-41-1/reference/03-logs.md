...
The logs signal is in **development** status as of v1.41.1. Breaking changes may occur before stabilization. The API and SDK provide the foundation for structured logging with trace correlation.
