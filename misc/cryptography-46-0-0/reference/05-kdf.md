...
- `Argon2d` — Maximizes resistance to time-memory-trade-off attacks, but has side-channel risks.
- `Argon2i` — Resists side-channel attacks, but vulnerable to time-memory-trade-off.
