...
| 54 | git | git | 2.54.0 | git, version-control, conventional-commits, keep-a-changelog, semver | Complete Git 2.54.0 toolkit covering version control workflows, Conventional Commits v1.0.0, Keep a Changelog message... |
...
| 98 | plan | plan | 0.1.0 | planning, workflow, task-management, read-only | Read-only exploration mode for safe code analysis. Restricts tools to read-only operations, extracts numbered steps... |
...
| 144 | tzip | tzip | 0.4.0 | token-prune, efficiency, guidelines | Lightweight token-pruning communication mode that drops filler and hedging while keeping full sentences and... |
...
| 149 | write-skill | write-skill | 0.7.2 | skill-writing, skill-generation, meta-skill, automation | Generate fine-grained agent skills from user requirements, creating complete spec-compliant markdown files that work... |
