...
| 42 | category-theory | category-theory | 0.1.0 | category-theory, mathematics, functional-programming, type-theory, monads | Mathematical framework for abstract structures and their relationships via categories, functors, natural ... |
...
| 72 | duckduckgo-2026-05-08 | duckduckgo | 0.1.0 | web-search, web search, duckduckgo | Searches DuckDuckGo using the HTML endpoint (default, html→markdown via scrapling) and JSON API (--format json), ... |
...
| 91 | lambda-calculus-2026-05-12 | lambda-calculus | 0.1.0 | lambda-calculus, functional-programming, type-theory, church-encoding, currying | Formal system for expressing computation via function abstraction and application. Covers untyped lambda calculus ... |
...
| 228 | websearch | websearch | 0.1.0 | meta, meta-skill, websearch, search, meta-skill | Meta skill that delegates web search tasks to the local duckduckgo-2026-05-08 skill. Use when performing web ... |
