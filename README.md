...
| qwen3-vl-embedding-2-0 | Qwen3-VL-Embedding | 2.0 | Python, PyTorch, transformers, multimodal, embeddings, MRL | Multimodal embedding models (2B/8B) for text, images, videos with Matryoshka Representation Learning and instruction tuning |
| qwen3-vl-reranker-2-0 | Qwen3-VL-Reranker | 2.0 | Python, PyTorch, transformers, multimodal, reranking, cross-attention | Multimodal reranking models (2B/8B) for precise relevance scoring in RAG pipelines with instruction tuning and cross-attention |
