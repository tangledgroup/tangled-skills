...
| 91 | lisp-in-python-2026-05-03 | lisp-in-python | 0.1.0 | lisp, interpreter, python, eval-apply, homoiconicity | "Complete guide to building a minimal Lisp interpreter in Python, synthesized from six independent implementations ... |
